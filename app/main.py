...
def sidebar():
    st.sidebar.header("🏥 App Predicción Tumor Benigno o Maligno")
...
def radar_chart(input_data): # Function to create the radar chart
...
def make_predictions(input_data):
    ...
    st.subheader("Predicción del Cluster Celular")
    st.write("El cluster celular es:")
    ...
    st.write("Probabilidad de que sea benigno: ", model.predict_proba(input_array_scaled)[0][0])
    st.write("Probabilidad de que sea maligno: ", model.predict_proba(input_array_scaled)[0][1])

def main():
    st.set_page_config( # Step 1. Set page configuration
        page_title = 'App Predicción Cáncer',
        layout = "wide",
